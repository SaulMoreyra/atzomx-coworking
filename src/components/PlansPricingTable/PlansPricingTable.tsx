...
const PricingRow: FC<PricingRowProps> = ({
  ...
  if (variant === "card") {
    return (
      <article className="flex flex-col border border-brand-green/10 bg-brand-cream p-5 md:p-6">
        ...
        <dl className="mt-4 grid grid-cols-3 gap-3 border-t border-brand-green/10 pt-4">
  ...
  return (
    <tr
      ...
      <td className="px-4 py-4 md:px-5">
        <WhatsAppLink
          message={bookMessage}
          className="text-label inline-flex min-h-[44px] items-center gap-2 rounded-brand border border-brand-green/20 bg-brand-cream px-4 py-2 text-xs text-brand-green transition-colors duration-200 hover:border-brand-green hover:bg-brand-main/50 focus-brand">
...
const PlansPricingTable: FC<PlansPricingTableProps> = ({ plans }) => {
  ...
  return (
    <>
      ...
      <section className="w-full bg-brand-cream py-14 md:py-20" aria-labelledby="pricing-table-heading">
        <div className="section-container max-w-5xl">
          ...
          <div className="hidden overflow-hidden border border-brand-green/10 lg:block">
            <table className="w-full border-collapse text-left text-sm">
              <caption className="sr-only">{t("title")}</caption>
              <thead>
                <tr className="border-b border-brand-green/15 bg-brand-main/60">
          ...
          <article className="mt-6 flex flex-col gap-3 border border-brand-green/10 bg-brand-main/40 p-5 md:flex-row md:items-center md:justify-between md:p-6">
            <div>
            ...
            <WhatsAppLink
              ...
              className="text-label inline-flex min-h-[44px] shrink-0 items-center justify-center rounded-brand border border-brand-green/25 bg-brand-cream px-5 py-3 text-xs text-brand-green transition-colors duration-200 hover:border-brand-green hover:bg-brand-accent/30 focus-brand">
              {t("freePlan.cta")}
            </WhatsAppLink>
          </article>
        </div>
