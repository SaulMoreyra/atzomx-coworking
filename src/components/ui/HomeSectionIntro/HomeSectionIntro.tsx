...
const HomeSectionIntro: FC<HomeSectionIntroProps> = ({
  ...
  <header className={cx("max-w-xl min-w-0", className)}>
    ...
    <TitleTag className="text-display-prose min-w-0 [overflow-wrap:anywhere] text-2xl font-bold leading-tight text-brand-green md:text-3xl lg:text-4xl">
      {title}
    </TitleTag>
    {subtitle ? (
      <>
        <div className="mt-4 h-px w-full max-w-[4rem] bg-brand-green/20" aria-hidden="true" />
