...
const ProductBanner: FC<ProductBannerProps> = ({
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-5 py-10 md:py-0">
          ...
          <m.div variants={animationVariants} className="relative z-50">
            <Link href={`/product/${name}`}>
              <Button className="text-2xl">Shop now</Button>
            </Link>
          </m.div>
        </div>
      </div>
      ...
      <h1 className="absolute -bottom-5 md:-bottom-9 left-[50%] -translate-x-[50%] text-7xl md:text-9xl font-bold whitespace-nowrap opacity-10">
